...
export const parseInsightRoomName = (value: string) =>
  value.startsWith(prefix) ? value.slice(prefix.length) : null;

export const findInsightRecord = (prisma: PrismaService, id: string) =>
...
export const appendInsightUpdate = (
...
export const storeInsightSnapshot = (
  prisma: PrismaService,
  id: string,
  data: Uint8Array,
) =>
