...
const HorizontalReportPage = memo(
  ({
    ...
    return (
      <article
        className={`report-detail-horizontal-page ${
      ...
      >
        <div className="report-detail-horizontal-slide">
          ...
          {hasChart ? (
            <ReportChartPanel builder={chartBuilder} onEdit={editChart} />
          ) : null}
          {!hasChart && !hasInsight ? (
            <Empty
...
export const HorizontalReportRenderer = memo(
  ({
    ...
    <section
      ref={stageRef}
      className="report-detail-stage report-detail-horizontal-stage"
    >
