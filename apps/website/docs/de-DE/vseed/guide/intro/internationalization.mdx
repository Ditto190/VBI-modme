...
VSeed bietet integrierte Internationalisierung. Über die Eigenschaft `locale` können Sie die Sprachumgebung wechseln (z. B. `zh-CN` für Chinesisch und `en-US` für Englisch).
