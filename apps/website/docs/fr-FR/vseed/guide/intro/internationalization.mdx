...
VSeed intègre la prise en charge de l'internationalisation. Configurez la propriété `locale` pour changer d'environnement linguistique (par exemple `zh-CN` pour le chinois et `en-US` pour l'anglais).
