...
VSeed mendukung berbagai tipe chart. Dengan properti `chartType`, Anda dapat dengan mudah beralih di antara berbagai bentuk visualisasi, termasuk chart umum, pivot table, dan lainnya.
