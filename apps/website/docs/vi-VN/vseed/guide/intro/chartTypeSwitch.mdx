...
VSeed hỗ trợ nhiều loại biểu đồ. Thông qua thuộc tính `chartType`, bạn có thể dễ dàng chuyển đổi giữa các hình thức trực quan hóa khác nhau, bao gồm biểu đồ thông thường, bảng pivot, v.v.
