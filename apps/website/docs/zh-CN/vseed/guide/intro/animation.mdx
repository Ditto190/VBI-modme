    ...
    animation: {
      ...
      params: {
        ...
        loop: {
          ...
          atmo: { effect: 'breath', ease: 'linear', color: '#F5A623' },
        },
      },
    },
  }
    ...
    animation: {
      ...
      params: {
        ...
        loop: {
          ...
          atmo: { effect: 'breath', ease: 'linear', color: '#7ED321' },
        },
      },
    },
  }
...
#### 2.1 load（加载轮播） + atmo（氛围效果：breath）
...
#### 2.2 load（加载轮播） + atmo（氛围效果：ripple）
