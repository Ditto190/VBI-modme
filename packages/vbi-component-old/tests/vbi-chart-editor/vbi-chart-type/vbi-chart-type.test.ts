...
describe('vbi-chart-type', () => {
  ...
  it('should render the popover panel with header and group sections', async () => {
    const el = await fixture<VBIChartTypeInstance>(html`<vbi-chart-type .data=${MOCK_GROUPS}></vbi-chart-type>`)
  ...
  it('should show empty message when data has no groups', async () => {
    const el = await fixture<VBIChartTypeInstance>(html`<vbi-chart-type .data=${[]}></vbi-chart-type>`)
  ...
  it('should accept a custom title', async () => {
    const el = await fixture<VBIChartTypeInstance>(html`<vbi-chart-type title="Pick chart"></vbi-chart-type>`)
