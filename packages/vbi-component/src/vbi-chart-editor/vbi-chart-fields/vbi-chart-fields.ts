...
export class VBIChartFields extends VdashElement {
  ...
  private _syncFieldDraggables(): void {
    ...
    this.renderRoot
      .querySelectorAll<HTMLElement>('[data-field-drag-id]')
      .forEach((element) => {
  ...
  private _createDragPreview(field: VBIChartField): void {
    ...
    icon.style.color = field.kind === 'measure'
  ...
  private _renderFieldItem(field: VBIChartField) {
    ...
    const itemClass = dragId === this._draggingFieldId
      ? 'field-item field-item--dragging'
      : 'field-item'
  ...
  override render() {
    return html`
      ...
      <div class="fields-search">
        <wa-input
          size="xs"
          placeholder=${translate('fieldsSearchPlaceholder')}
          with-clear
      ...
      <div class="fields-scroll">
        ...
        <section class="fields-section">
          ...
          <div class="fields-list">
            ${this._dimensions.map((f) => this._renderFieldItem(f))}
          </div>
        </section>
        ...
        <section class="fields-section">
          ...
          <div class="fields-list">
            ${this._measures.map((f) => this._renderFieldItem(f))}
          </div>
        </section>
      </div>
    `
