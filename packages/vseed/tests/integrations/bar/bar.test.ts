...
import config_4 from './annotation/annotationDifferenceLineStackedElement.json'
import config_5 from './annotation/annotationDifferenceLineValue.json'
import config_6 from './axes/barXAxis.json'
import config_7 from './axes/barXAxisEnable.json'
import config_8 from './axes/barYAxis.json'
import config_9 from './axes/barYAxisEnable.json'
import config_10 from './axes/xAxisHorizontal.json'
import config_11 from './axes/yAxisHorizontal.json'
import config_12 from './barStyle/nearlyEqual.json'
import config_13 from './baseConfig/baseConfigBackgroundColor.json'
...
import config_19 from './color/pivot-color-dim.json'
...
import config_23 from './markStyle/barStylePartialDatum.json'
import config_24 from './markStyle/selectorBarPartialDatum.json'
import config_25 from './pivotGrid/pivotBasic.json'
import config_26 from './pivotGrid/pivotBasicV2.json'
import config_27 from './tooltip/bar.json'
...
const cases = [
  ...
  { name: 'annotation/annotationDifferenceLineStackedElement', vseed: config_4 },
  { name: 'annotation/annotationDifferenceLineValue', vseed: config_5 },
  { name: 'axes/barXAxis', vseed: config_6 },
  { name: 'axes/barXAxisEnable', vseed: config_7 },
  { name: 'axes/barYAxis', vseed: config_8 },
  { name: 'axes/barYAxisEnable', vseed: config_9 },
  { name: 'axes/xAxisHorizontal', vseed: config_10 },
  { name: 'axes/yAxisHorizontal', vseed: config_11 },
  { name: 'barStyle/nearlyEqual', vseed: config_12 },
  { name: 'baseConfig/baseConfigBackgroundColor', vseed: config_13 },
  ...
  { name: 'color/pivot-color-dim', vseed: config_19 },
  { name: 'combination/basic', vseed: config_20 },
  { name: 'combination/basicV2', vseed: config_21 },
  { name: 'dataset/onlyMeasures', vseed: config_22 },
  { name: 'markStyle/barStylePartialDatum', vseed: config_23 },
  { name: 'markStyle/selectorBarPartialDatum', vseed: config_24 },
  { name: 'pivotGrid/pivotBasic', vseed: config_25 },
  { name: 'pivotGrid/pivotBasicV2', vseed: config_26 },
  { name: 'tooltip/bar', vseed: config_27 }
]
