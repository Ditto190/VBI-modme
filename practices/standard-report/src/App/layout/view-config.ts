...
import { REPORT_DEFAULT_LOCALE, REPORT_DEFAULT_THEME, type ReportLocale, type ReportTheme } from 'src/constants/builder'
...
export const getActiveViewConfig = (reportBuilder: VBIReportBuilder, activePageId: string) => {
