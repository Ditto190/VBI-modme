...
export const createShelfInsertId = (params: { shelf: ShelfType; insertIndex: number; anchor: ShelfInsertAnchor }) => {
  return `shelf-insert:${params.shelf}:${params.insertIndex}:${params.anchor}`
}

export const createSchemaFieldDragId = (params: { field: string; role: FieldRole }) => {
